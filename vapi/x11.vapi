...
namespace X {
	...
	public class Display {
        ...
        [CCode (cname = "XChangeKeyboardMapping")]
        public int change_keyboard_mapping(int min_keycode, int keysyms_per_keycode, [CCode (array_length = false)] ulong[] keysyms, int num_codes);
	}
